...
public interface RaceDAO {
    ...
    public void setHoresPositionInRace(
     ...
     * 
     * @return
     *     returns java.util.List<by.isysoi.dao.Race>
     */
    @WebMethod
    ...
    public List<Race> readRacesByDate(
        @WebParam(name = "arg0", targetNamespace = "")
